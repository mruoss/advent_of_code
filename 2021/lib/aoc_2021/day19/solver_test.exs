defmodule AOC2021.Day19.SolverTest do
  use ExUnit.Case, async: true

  alias AOC2021.Day19.Solver, as: MUT
  ...
  describe "solve/2" do
    ...
    test "should solve first task with first test input from website correctly" do
      ...
      assert 79 == MUT.solve(stream, :first)
    end
    ...
    test "should solve first task for puzzle input correctly" do
      input = File.stream!("priv/input/day19.txt") |> Stream.map(&String.trim/1)
      assert 496 == MUT.solve(input, :first)
    end
    ...
    test "should solve second task with first test input from website correctly" do
      ...
      assert 3621 == MUT.solve(stream, :second)
    end
    ...
    test "should solve second task for puzzle input correctly" do
      input = File.stream!("priv/input/day19.txt") |> Stream.map(&String.trim/1)
      assert 14478 == MUT.solve(input, :second)
    end
  end
end
